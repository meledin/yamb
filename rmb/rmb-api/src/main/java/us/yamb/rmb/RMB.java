...
/**
 * REST Message Bus extends the message bus functionality to apply RESTful semantics.
 * 
...
public interface RMB extends MBMethods<RMBStatus, ChannelBuilder, Send>, Observable<RMBCallbackInterface, RMB>
{
    ...
    /**
     * Create a new instance as a subresource of the current resource. The new instance will have the given ID. A sample
     * returned URI might be (assuming this RMB instance is /foo and the supplied argument is "bar")
     * <p>
     * 
     * <pre>
     * /foo/bar
    ...
    /**
     * Create a {@link PipeBuilder} to make a {@link Pipe}. Pipes are high-performance conduits to send identical messages
     * repeatedly. When sending messages over a pipe, the implementation may perform optimisations knowing that there will be a
     * series of messages going over the same path. Inversely, for one-time (or sporadic) messages, making a pipe may require
    ...
    /**
     * Create a GET request to the given location. The parameter will be automatically parsed as a {@link Location} object.
     * 
     * @param to
    ...
    /**
     * Create a PUT request to the given location. The parameter will be automatically parsed as a {@link Location} object.
     * 
     * @param to
    ...
    /**
     * Create a POST request to the given location. The parameter will be automatically parsed as a {@link Location} object.
     * 
     * @param to
    ...
    /**
     * Create a DELETE request to the given location. The parameter will be automatically parsed as a {@link Location} object.
     * 
     * @param to
    ...
    /**
     * Sets a handler that will be called when the connection to the message broker is broken. This can be used for
     * cleanup/error handling purposes.
     * 
     * @param cb
     * @return
     */
    ...
    /**
     * Sets a handler to be called when a DELETE message is received by this node.
     * 
     * @param cb
     *            The handler to call
    ...
    /**
     * Sets a handler to be called when a message with an unknown method, or with a method that was not handled by a more
     * specific handler, is received by this node.
     * 
     * @param cb
     *            The handler to call
     * @return This object, for chaining
    ...
    /**
     * Remove this RMB instance from the tree. This will disconnect any children of this instance, if any. This method is a
     * no-op if called on the root RMB instance.
     */
    public void remove();
